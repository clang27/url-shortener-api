...
public class RedirectEventServiceTest extends DatabaseTest {
    ...
    public void gettingTodaysRedirects_ShouldBeTwo_WhenThereAreTwo() {
        ...
        assertThat(countOne.contains(new TotalRedirectCountResponse(SLUG, TARGET, 2L))).isTrue();
        assertThat(countTwo.contains(new TotalRedirectCountResponse(SLUG, TARGET, 0L))).isTrue();
        assertThat(countThree.contains(new TotalRedirectCountResponse(SLUG, TARGET, 0L))).isTrue();
    }
